...
- **Geração de QR Code:** Crie uma página para impressão com um QR Code exclusivo para sua lista. Cole-o onde for mais conveniente!

### Para Colaboradores (Visitantes da Página Pública)

- **Acesso Rápido e Sem Login:** Não é necessário criar uma conta para colaborar. Basta acessar o link ou escanear o QR Code.
- **Interface Simples:** Com um design limpo e direto, qualquer pessoa pode adicionar um item em segundos.
- **Comunicação Direta:** Deixe uma mensagem para o dono da lista, seja para sugerir um novo produto ou tirar uma dúvida.
